 ...
 */
SocialTracker.prototype.handleSocialClicks = function handleSocialClicks(
  event
) {
 ...
 * @param {Object} event The Twitter event object passed to the handler.
 */
SocialTracker.prototype.handleFollowEvents = function handleFollowEvents(
  event
) {
  ...
  const screenName =
    event.data.screen_name || event.target.getAttribute("data-screen-name");
